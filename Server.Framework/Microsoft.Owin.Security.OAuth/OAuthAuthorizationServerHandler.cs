...
namespace Microsoft.Owin.Security.OAuth
{
    internal class OAuthAuthorizationServerHandler : AuthenticationHandler<OAuthAuthorizationServerOptions>
    {
        ...
        {
            var authorizeRequest = new AuthorizeEndpointRequest(new ReadableStringCollection(_requestEndpointParameters));
        ...
        private async Task InvokeTokenEndpointAsync()
        {
            ...
            var clientContext = new OAuthValidateClientAuthenticationContext(
                Context,
                Options,
                new ReadableStringCollection(_requestEndpointParameters));
            ...
            var tokenEndpointRequest = new TokenEndpointRequest(clientContext.Parameters);
