...
namespace Microsoft.Owin.Security
{
    public static class AuthenticationManagerExtensions
    {
        ...
        public static async Task<string> GetOAuthLoginInfoAsync(this IAuthenticationManager manager)
        {
            return await manager.GetOAuthLoginInfoAsync("ExternalCookie");
        }

        public static async Task<string> GetOAuthLoginInfoAsync(this IAuthenticationManager manager, string authenticationType)
        {
            if (manager == null)
            {
