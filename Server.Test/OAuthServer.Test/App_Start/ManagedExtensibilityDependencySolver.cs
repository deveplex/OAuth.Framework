...
namespace GMF.Demo.Site.Helper.Ioc
{
    public class ManagedExtensibilityDependencySolver : IDependencyResolver
    {
        private readonly ComposablePartCatalog _catalog;
        private const string MefContainerKey = "MefContainerKey";

        public ManagedExtensibilityDependencySolver(ComposablePartCatalog catalog)
        {
            _catalog = catalog;
        }
