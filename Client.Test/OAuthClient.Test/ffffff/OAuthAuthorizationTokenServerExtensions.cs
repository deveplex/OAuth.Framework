...
    /// </summary>
    public static class OAuthAuthorizationTokenServerExtensions
    {
        /// <summary>
...
        public static IAppBuilder UseOAuthAuthorizationTokenServer(this IAppBuilder app, OAuthAuthorizationTokenServerOptions options)
        {
            if (app == null)
            {
            ...
            app.Use(typeof(OAuthAuthorizationTokenServerMiddleware), app, options);
            return app;
        }
    }
}