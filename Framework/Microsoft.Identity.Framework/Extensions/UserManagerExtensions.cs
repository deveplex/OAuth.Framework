...
namespace Microsoft.Identity
{
    ...
    public static class UserManagerExtensions
    {
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        public static IEnumerable<KeyValuePair<TKey, string>> GetRoles<TUser, TKey>(this UserManager<TUser, TKey> manager, TKey userId)
            where TKey : IEquatable<TKey>
            where TUser : class, IUser<TKey>
        {
            if (manager == null)
            ...
            return AsyncHelper.RunSync(() => manager.GetUserRolesAsync(userId));
        }
        ...
        /// <param name="role"></param>
        /// <returns></returns>
        public static bool IsInRole<TUser, TKey>(this UserManager<TUser, TKey> manager, TKey userId, TKey role)
            where TKey : IEquatable<TKey>
            where TUser : class, IUser<TKey>
        {
            if (manager == null)
        ...
        public static void SendEmail<TUser, TKey>(this UserManager<TUser, TKey> manager, string email, string subject, string body)
            where TKey : IEquatable<TKey>
            where TUser : class, IUser<TKey>
        {
            if (manager == null)
            ...
            AsyncHelper.RunSync(() => manager.SendEmailAsync(email, subject, body));
        }
        ...
        public static void SendSms<TUser, TKey>(this UserManager<TUser, TKey> manager, string phoneNumber, string message)
            where TKey : IEquatable<TKey>
            where TUser : class, IUser<TKey>
        {
            if (manager == null)
            ...
            AsyncHelper.RunSync(() => manager.SendSmsAsync(phoneNumber, message));
        }
